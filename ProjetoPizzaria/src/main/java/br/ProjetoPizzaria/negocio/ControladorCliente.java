...
private static ControladorCliente instance;
	...
	{
		if(obj != null && obj.getCPF() != null && obj.getNome() != null)
	...
	public void atualizar(Cliente obj, String nome, String CPF) throws ElementoNaoExisteException
	{
		if(repositorioClientes.listar().contains(obj)) {
		obj.setNome(nome);
		obj.setCPF(CPF);
		obj.setNumeroDeCompras(obj.getNumeroDeCompras());
